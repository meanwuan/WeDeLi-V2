    ...
    public class DriverRepository : IDriverRepository
    {
        ...
        public async Task<Driver> AddAsync(Driver entity)
        {
            try
            {
                ...
                if (await _context.Drivers.AnyAsync(d => d.UserId == entity.UserId))
                    throw new InvalidOperationException($"User {entity.UserId} is already a driver");
                ...
                _logger.LogInformation("Added new driver: {DriverId} ({UserId})", entity.DriverId, entity.UserId);
                return entity;
            }
            catch (Exception ex)
            {
        ...
        public async Task<Driver> UpdateAsync(Driver entity)
        {
            try
            {
                ...
                _logger.LogInformation("Updated driver: {DriverId} ({UserId})", entity.DriverId, entity.UserId);

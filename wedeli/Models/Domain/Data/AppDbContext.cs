...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;database=wedeli;user=root;password=Quangml@04", ServerVersion.Parse("9.5.0-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CompanyPartnership>(entity =>
        {
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.CompanyPartnershipCompanies)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("company_partnerships_ibfk_1");

            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.CompanyPartnerships).HasConstraintName("company_partnerships_ibfk_3");

            entity.HasOne(d => d.PartnerCompany).WithMany(p => p.CompanyPartnershipPartnerCompanies)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("company_partnerships_ibfk_2");
        });
        ...
        modelBuilder.Entity<Complaint>(entity =>
        {
            ...
            entity.HasOne(d => d.ResolvedByNavigation).WithMany(p => p.Complaints).HasConstraintName("complaints_ibfk_3");
        });
        ...
        modelBuilder.Entity<OrderTransfer>(entity =>
        {
            ...
            entity.HasOne(d => d.FromCompany).WithMany(p => p.OrderTransferFromCompanies)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("order_transfers_ibfk_2");
            ...
            entity.HasOne(d => d.ToCompany).WithMany(p => p.OrderTransferToCompanies)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("order_transfers_ibfk_3");

            entity.HasOne(d => d.TransferredByNavigation).WithMany(p => p.OrderTransfers)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("order_transfers_ibfk_6");
        });
        ...
        modelBuilder.Entity<PeriodicInvoice>(entity =>
        {
            ...
            entity.HasOne(d => d.Company).WithMany(p => p.PeriodicInvoices)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("periodic_invoices_ibfk_2");

            entity.HasOne(d => d.Customer).WithMany(p => p.PeriodicInvoices)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("periodic_invoices_ibfk_1");
        });

...
public partial class CompanyPartnership
{
    ...
    [InverseProperty("CompanyPartnershipCompanies")]
    public virtual TransportCompany Company { get; set; } = null!;

    [ForeignKey("CreatedBy")]
    [InverseProperty("CompanyPartnerships")]
    public virtual User? CreatedByNavigation { get; set; }

    [ForeignKey("PartnerCompanyId")]
    [InverseProperty("CompanyPartnershipPartnerCompanies")]
    public virtual TransportCompany PartnerCompany { get; set; } = null!;
}

        ...
        public MappingProfile()
        {
            ...
            CreateMap<User, LoginResponseDto>()
                ...
                .ForMember(dest => dest.CompanyId, opt => opt.MapFrom(src =>
                    src.Drivers.Any() ? src.Drivers.First().CompanyId :
                    src.WarehouseStaffs.Any() ? (int?)src.WarehouseStaffs.First().CompanyId : null))
                .ForMember(dest => dest.CompanyName, opt => opt.MapFrom(src =>
                    src.Drivers.Any() ? src.Drivers.First().Company.CompanyName :
                    src.WarehouseStaffs.Any() ? src.WarehouseStaffs.First().Company.CompanyName : null));
            ...
            CreateMap<Order, OrderResponseDto>()
                ...
                .ForMember(dest => dest.IsRegularCustomer, opt => opt.MapFrom(src => src.Customer.IsRegular))
            ...
            CreateMap<Order, OrderDetailDto>()
                ...
                .ForMember(dest => dest.CompanyName, opt => opt.MapFrom(src => src.Vehicle != null ? src.Vehicle.Company.CompanyName : null));
            ...
            CreateMap<CompanyPartnership, PartnershipResponseDto>()
                .ForMember(dest => dest.CompanyName, opt => opt.MapFrom(src => src.Company.CompanyName))
                .ForMember(dest => dest.PartnerCompanyName, opt => opt.MapFrom(src => src.PartnerCompany.CompanyName));
            ...
            CreateMap<OrderTransfer, OrderTransferResponseDto>()
                .ForMember(dest => dest.TrackingCode, opt => opt.MapFrom(src => src.Order.TrackingCode))
                .ForMember(dest => dest.FromCompanyName, opt => opt.MapFrom(src => src.FromCompany.CompanyName))
                .ForMember(dest => dest.ToCompanyName, opt => opt.MapFrom(src => src.ToCompany.CompanyName));
            ...
            CreateMap<Models.Domain.Rating, RatingResponseDto>()
                ...
                .ForMember(dest => dest.CustomerName, opt => opt.MapFrom(src => src.Customer.FullName))
                .ForMember(dest => dest.DriverName, opt => opt.MapFrom(src =>
                    src.Driver != null ? src.Driver.User.FullName : null));
